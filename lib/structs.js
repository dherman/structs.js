...
// - tests
// - struct padding
// - be consistent about using this._type and lexical t
// - figure out how to censor size/offset info for opaque data

var Structs = (function() {

var hasOwn = {}.hasOwnProperty.call.bind({}.hasOwnProperty);

function forEachOwn(obj, f, self) {
...
function struct(desc, name) {
    ...
    // FIXME: how to make these next two properties portable even with padding, pointer sizes, etc?
    // - NaN? 0?
    // - throw?
    // - no such property?
    ...
    forEachOwn(desc, function(fieldName) {
...
function array(elementType, length) {
    ...
    // FIXME: how to make these next three properties portable even with padding, pointer sizes, etc?
    // - NaN? 0?
    // - throw?
    // - no such property?
