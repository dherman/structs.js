...
// brand of type objects (simulating something like [[Class]] == "BufferType")
const TYPE = {};

// brand of view objects (simulating something like [[Class]] == "BufferView")
const VIEW = {};
...
Object.defineProperty(TypedBuffer.prototype, "byteLength", {
    enumerable: false,
    configurable: false,
    get: function() {
...
function struct(desc, name) {
    ...
    t.toSource = function() {
        return "struct"
             ...
             + " { "
             + Object.keys(this._fieldTypes)
                     .map(function(fieldName) {
                              return fieldName + ": " + this._fieldTypes[fieldName]._shortName
                          }, this)
                     .join(", ")
             + " }";
    };
    ...
    p.update = function(x) {
        for (var fieldName in this._type._fieldTypes) {
            this[fieldName] = x[fieldName];
        }
    };

    p.toString = function() {
        return "[struct" + (this._type._structName ? " " + this._type._structName : "") + "]";
    };

    p.toSource = function() {
        return this._type._shortName
             + "({ "
             + Object.keys(this._type._fieldTypes)
                     .map(function(fieldName) {
    ...
    Object.defineProperty(p, "byteLength", {
        ...
        configurable: false,
        get: function() {
            if (this._buffer instanceof TypedBuffer)
    ...
    t._write = function write(x, raw, i, buf) {
        ...
        for (var fieldName in this._fieldTypes) {
            var fieldType = this._fieldTypes[fieldName];
...
function array(elementType, length) {
    ...
    function t(x, byteOffset, instanceLength) {
        ...
        switch (typeof x) {
          case "number":
            ...
            self._buffer = new TypedBuffer(array(t._elementType, instanceLength));
            self._raw = self._buffer._raw;
            self._byteOffset = 0;
            break;
            ...
            for (var i = 0; i < instanceLength; i++) {
                (function() {
                    ...
                    Object.defineProperty(self, i, {
                        ...
                        configurable: false,
                        get: function() {
                            var elementType = self._type._elementType;
    ...
    t.toSource = function() {
        return "array(" + this._type._elementType.toSource() + ")";
    };
    ...
    Object.defineProperty(p, "BYTES_PER_ELEMENT", {
        ...
        get: function() {
            ...
            var elementType = this._type._elementType;
            return elementType._byteLength;
        }
    });
...
function pointer(targetType) {
    ...
    return {
        ...
        // (Object, ArrayBuffer, index, TypedBuffer) -> void
        _write: function(obj, raw, i, buf) {
            if (typeof obj !== "object" || (obj !== null && (obj._class !== VIEW || !obj._type._sameType(this._targetType))))
